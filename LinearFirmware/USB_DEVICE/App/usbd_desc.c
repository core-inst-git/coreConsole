...
#define USBD_MANUFACTURER_STRING     "Core-Instrumentation"
#define USBD_PID_HS     22336
#define USBD_PRODUCT_STRING_HS     "CoreDAQ_Virtual_COM"
...
/* Keep these overrides inside USER CODE so CubeMX regeneration preserves them. */
#undef USBD_MANUFACTURER_STRING
#undef USBD_PRODUCT_STRING_HS
#define USBD_MANUFACTURER_STRING     "core_instrumentation"
#define USBD_PRODUCT_STRING_HS       "coreDAQ"
