...
contextBridge.exposeInMainWorld('coredaq', {
  ...
  listSerialPorts: () => ipcRenderer.invoke('coredaq:list-serial-ports')
});
...
contextBridge.exposeInMainWorld('gpib', {
  ...
  probeIdn: (resource, timeoutMs, maxBytes) =>
    ipcRenderer.invoke('gpib:probe-idn', { resource, timeoutMs, maxBytes }),
